...
public class ProfileManager
{
    ...
    private static final String PROFILE_DATA_FILE = "data/profile-audiogility.json";
    ...
    public Profile retrieveProfile()
    {
        ...
        Gdx.app.log( Audiogility.LOG, "Retrieving profile from: " + profileDataFile.path() );
        ...
        if( profileDataFile.exists() ) {
            ...
            try {
                ...
                if( profileAsText.matches( "^[A-Za-z0-9/+=]+$" ) ) {
                    Gdx.app.log( Audiogility.LOG, "Persisted profile is base64 encoded" );
                ...
                // log the exception
                Gdx.app.error( Audiogility.LOG, "Unable to parse existing profile data file", e );
        ...
        Profile profile )
    {
        // create the handle for the profile data file
        FileHandle profileDataFile = Gdx.files.local( PROFILE_DATA_FILE );
        Gdx.app.log(Audiogility.LOG, "Persisting profile in: " + profileDataFile.path() );
